                ...
                <Row>
                    <Col lg="6" sm="12">
                        <div className={style.featureWrapper}>
                            <h3 className={style.featureTitle}>Search for devices</h3>
                            <img className={style.featureScreenshot}
                                src="/images/SearchScreenshot.png"></img>
                        </div>
                    </Col>
                    <Col lg="6" sm="12">
                        <div className={style.featureWrapper}>
                            <h3 className={style.featureTitle}>Find device predicate ancestry</h3>
                            <img className={style.featureScreenshot}
                                src="/images/DeviceGraphScreenshot.png"></img>
                        </div>
                    </Col>
                </Row>
            </Container>
